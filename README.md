...
<p align="center">
  <img src="https://img.shields.io/badge/Research-Thesis%20Project-6A5ACD?style=flat-square">
  <img src="https://img.shields.io/badge/ML-NLP%20Based-0A66C2?style=flat-square">
  <img src="https://img.shields.io/badge/Accuracy-94%25%20Best%20Model-success?style=flat-square">
...
This project presents a **machine learning–based system** for detecting and classifying mental health conditions from social media text.

It is the final year research thesis project by **Maaz Kareem (Gold Medalist)**, focusing on:
- Interpretability of classical ML models  
- Cross-domain generalization  
- Ethical AI for mental health monitoring  

---

## 🎯 Problem Statement

Mental health issues are often under-reported. This system aims to:
- Detect mental health signals from text data
- Classify multiple psychological conditions
- Enable scalable and interpretable AI-based screening
...
Three multi-source datasets were used to ensure robustness and generalization:

### 1️⃣ Combined Dataset
- Aggregated from multiple Kaggle sources  
- Used for training and evaluation  
- 7-class labeled dataset  

### 2️⃣ Sentiment Mental Health Dataset
- Reddit + Zenodo sources  
- Used for cross-domain testing  
- Ensures real-world generalization  

### 3️⃣ Final Merged Dataset
- Combination of Dataset 1 & 2  
- Used for final robustness evaluation  
...
- Best Model: **LightGBM (Train Data)**
- Best Generalization: **Random Forest (Cross-domain data)**

---

## 🧠 Key Insights

- SVM performs best for binary mental health detection  
- Random Forest generalizes better across unseen datasets  
- Classical ML models remain highly effective and interpretable  
- Cross-domain testing is critical for real-world deployment  
...
- Research follows ethical AI guidelines for mental health applications  
...
- Multilingual expansion (Urdu / Pashto / regional languages)  
